      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="group rounded-3xl overflow-hidden shadow-xl border border-gray-100 bg-gray-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl bg-background border border-gray-100 shadow-sm hover:shadow-xl transition duration-300">
